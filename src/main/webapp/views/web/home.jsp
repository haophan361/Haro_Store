...
<body>
        ...
        <div class="container px-3 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="search-container">
                	<form>
                		<input type="text" placeholder="Tìm kiếm" name="query" id="searchInput">
    ...
    <script>
		document.getElementByID("searchInput").addEventListener("input",function
		{
			...
			<a href="ProductServlet?action=edit&id=${c.id}" class="btn btn-primary">
		});
	</script>
    <!-- Include JavaScript files before closing the body tag -->
